...
import com.geuphalttaen.infra.ncp.DirectionsApiClient
import com.geuphalttaen.infra.ncp.DirectionsResult
...
class DirectionsController(private val directionsApiClient: DirectionsApiClient) {
    ...
    fun getDirections(
        ...
        ApiResponse.ok(directionsApiClient.getDirections(startLat, startLng, endLat, endLng))
}
